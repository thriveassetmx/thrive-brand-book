...
2. Export full logo lockups for Creative Exchange and Hospitality MX — same process as
   Property MX/Assets MX/Capital MX, see `00-shared/EXPORT-FROM-AFFINITY.md`.
3. Export the missing full-color SVG for Capital MX (only the PNG exists so far).
4. Turn Property MX's, Assets MX's, and Capital MX's favicon source marks into proper
   16/32/180/512/.ico sets.
5. Fill in `00-shared/color-system.md` with confirmed HEX/RGB/CMYK/Pantone values.
